    ...
    try {
      ...
      if (!isNaN(ram) && !isNaN(disk) && !isNaN(cpu)) {
        ...
        if (egginfo.limits.minimum.ram) {
          if (srvram < egginfo.limits.minimum.ram) {
        ...
        if (egginfo.limits.minimum.disk) {
          if (srvdisk < egginfo.limits.minimum.disk) {
        ...
        if (egginfo.limits.minimum.cpu) {
          if (srvcpu < egginfo.limits.minimum.cpu) {
        ...
        if (egginfo.limits.maximum) {
          if (egginfo.limits.maximum.ram) {
            if (srvram > egginfo.limits.maximum.ram) {
          ...
          if (egginfo.limits.maximum.disk) {
            if (srvdisk > egginfo.limits.maximum.disk) {
          ...
          if (egginfo.limits.maximum.cpu) {
            if (srvcpu > egginfo.limits.maximum.cpu) {
