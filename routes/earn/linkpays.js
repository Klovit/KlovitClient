...
module.exports.load = async function (app, db) {
  ...
  app.get(`/earn/lp/redeem/:code`, async (req, res) => {
    ...
    if (((Date.now() - usercode.generated) / 1000) < settings.linkpays.minTimeToComplete) {
        return res.send('<p>Hm... our systems detected something going on! Please make sure you are not using an ad blocker (or LinkPays bypasser). <a href="/earn">Generate another link</a></p> <img src="https://i.imgur.com/lwbn3E9.png" alt="robot" height="300">')
    }
