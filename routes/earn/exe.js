...
module.exports.load = async function (app, db) {
  ...
  app.get(`/earn/exeio/redeem/:code`, async (req, res) => {
    ...
    if (((Date.now() - usercode.generated) / 1000) < settings.exelinks.minTimeToComplete) {
        return res.send('<p>Hm... our systems detected something going on! Please make sure you are not using an ad blocker (or ExeIO bypasser). <a href="/earn">Generate another link</a></p> <img src="https://i.imgur.com/lwbn3E9.png" alt="robot" height="300">')
    }
    ...
    res.redirect(`/earn?err=SUCCESSEXE`)
})
};
